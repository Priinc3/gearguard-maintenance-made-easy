...
Since your `package.json` includes **Supabase** (`@supabase/supabase-js`), your project **will not run** without the environment variables.

Make sure you create a `.env` file in your project root and add your specific Supabase URL and Key, otherwise, the app will crash when trying to fetch data!
